...
<body>
    ...
    <div class="main-container">
        ...
        <div class="landing-page-title-container">
            ...
            <h1 class="landing-page-title-logo">CHORD</h1>
            <h1 class="landing-page-title-logo">VISUALIZER</h1>
        ...
        if (isset($_SESSION["user_id"])) {
            ...
            echo '<input class="form-input song-name" type="text" placeholder="Enter song name" id="song_name" name="song_name" required>';
            echo '<input class="form-input song-author" type="text" placeholder="Enter song author" id="song_author" name="song_author" required>';
            echo '<div class="submit-button-container">';
            echo '<button class="submit-button" type="submit">To Editor</button>';
            echo '</div>';
            echo '</form>';
            echo '</div>';
            echo '</div>';
